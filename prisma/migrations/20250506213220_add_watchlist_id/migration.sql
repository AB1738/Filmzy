...
-- AddForeignKey
ALTER TABLE "LikedMovie" ADD CONSTRAINT "LikedMovie_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LikedMovie" ADD CONSTRAINT "LikedMovie_movieId_fkey" FOREIGN KEY ("movieId") REFERENCES "Movie"("movieId") ON DELETE RESTRICT ON UPDATE CASCADE;
